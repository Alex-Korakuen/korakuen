...
createTemplate('quotes-template.xlsx', [
  ...
  { key: 'exchange_rate',          required: 'Yes',  description: 'Exchange rate (PEN per USD). Auto-filled from DB if blank', example: '3.72', valid: '2.5–6.0' },
  { key: 'status',                 required: 'Yes',  description: 'Quote status',                   example: 'pending',          valid: 'pending, accepted, rejected' },
  { key: 'document_ref',           required: 'Yes',  description: 'Quote number (grouping key)',    example: 'COT-001',          valid: 'Rows w/ same value → one quote' },
  { key: 'notes',                  required: 'No',   description: 'Notes',                          example: '' },
], [
  'Notes:',
  '  - Rows with the same document_ref are grouped into ONE quote with multiple line items',
  '  - All grouped rows must share the same partner, project, supplier, date, currency, status, notes',
