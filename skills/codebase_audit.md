...
- [ ] The 9 soft-delete tables have `is_active` (partner_companies, bank_accounts, entities, entity_contacts, tags, projects, categories, project_budgets, project_partners). All tables have `created_at`. All tables have `updated_at` except `entity_tags`
