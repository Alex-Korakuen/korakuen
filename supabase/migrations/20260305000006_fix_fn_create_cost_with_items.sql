-- ============================================================
-- Korakuen Management System — Fix fn_create_cost_with_items
-- Migration: 20260305000006
-- Date: 2026-03-05
--
-- Removes valuation_id reference (table was dropped in
-- migration 20260305000002). Recreates the function without it.
-- ============================================================
...
-- ============================================================
-- End of migration 20260305000006
-- Rollback: Restore previous version with valuation_id column
-- ============================================================
