-- Migration: Create v_invoices_with_loans view
-- Purpose: Unified view of all commercial invoices + loan schedule entries, all statuses, with aging buckets.
-- Used by: Invoices browse page (Phase 5.1)
