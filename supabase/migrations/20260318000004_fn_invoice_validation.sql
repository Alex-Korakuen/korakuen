-- Add server-side validation to fn_create_invoice_with_items.
-- Client (import-actions.ts) already validates, but the function should
-- return clear errors instead of cryptic PostgreSQL cast/constraint failures
-- if bad JSONB reaches it.
