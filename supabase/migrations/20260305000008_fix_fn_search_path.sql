-- ============================================================
-- Korakuen Management System — Fix fn_create_cost_with_items search_path
-- Migration: 20260305000008
-- Date: 2026-03-05
--
-- Sets explicit search_path on fn_create_cost_with_items to
-- resolve Supabase Security Advisor warning about mutable
-- search_path.
-- ============================================================
...
-- ============================================================
-- End of migration 20260305000008
-- Rollback: Remove SET search_path line from function definition
-- ============================================================
