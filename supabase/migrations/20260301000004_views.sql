-- ============================================================
-- SUPERSEDED by 20260301000007_views_security_invoker.sql
-- All views in this migration are recreated with
-- security_invoker = on in migration 007.
-- This migration is kept for history only — do not edit.
-- ============================================================
-- Korakuen Management System — All Database Views
-- Migration: 004 (combined from supabase/views/)
-- Date: 2026-03-01
-- ============================================================
...
CREATE OR REPLACE VIEW v_cost_balances AS
SELECT
  ct.cost_id,
  ct.project_id,
  ct.entity_id,
...
CREATE OR REPLACE VIEW v_ar_balances AS
WITH ar_base AS (
  SELECT
...
CREATE OR REPLACE VIEW v_ap_calendar AS
SELECT
  cb.cost_id,
  cb.project_id,
  p.project_code,
...
CREATE OR REPLACE VIEW v_partner_ledger AS
...
CREATE OR REPLACE VIEW v_entity_transactions AS
...
CREATE OR REPLACE VIEW v_company_pl AS
...
CREATE OR REPLACE VIEW v_settlement_dashboard AS
SELECT
  ab.ar_invoice_id,
  ab.project_id,
  p.project_code,
...
CREATE OR REPLACE VIEW v_retencion_dashboard AS
WITH ar_base AS (
  SELECT
    ar.id                 AS ar_invoice_id,
    ar.project_id,
